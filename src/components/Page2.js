        ...
        <div className='PageContainer-Page2'>
            ...
            <div className='MainContainer'>
                ...
                <div className='Container'>
                    ...
                    {SecondToggleBtn()}
                    <p className='SubTitle2'>Some other Text here</p>
